...
@section('content')
    ...
    <div class="form-group text-center">
        ...
        {!! Form::open(['url' => '/admin/edit/'.request('id'), 'files' => 'true']) !!}
        ...
        @foreach($ticket->status as $userStatus)

            @foreach($allStatus as $status)

                @if($userStatus->id == $status->id)

                {!! Form::checkbox('status[]', $status->id, ['checked' => true]) !!}
